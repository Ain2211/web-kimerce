...
namespace Kimerce.Backend.Dto
{
    public static class MappingExtensions
    {
        ...
        public static NewsItem ToItem(this News entity)
        {
            return entity.MapTo<News, NewsItem>();
        }
        ...
        #endregion
        #region NewsImage
        public static NewsImageItem ToItem(this NewsImage entity)
        {
            return entity.MapTo<NewsImage, NewsImageItem>();
        }

        public static NewsImageModel ToModel(this NewsImage entity)
        {
            return entity.MapTo<NewsImage, NewsImageModel>();
        }

        public static NewsImage ToNewsImage(this NewsImageModel model)
        {
            return model.MapTo<NewsImageModel, NewsImage>();
        }

        public static NewsImage ToNewsImage(this NewsImage entity, NewsImage destination)
        {
            return entity.MapTo(destination);
        }
        #endregion
